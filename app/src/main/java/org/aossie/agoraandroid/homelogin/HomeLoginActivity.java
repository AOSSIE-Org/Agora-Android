...
import org.aossie.agoraandroid.login.LoginViewModelFactory;
...
public class HomeLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoginViewModelFactory loginViewModelFactory = new LoginViewModelFactory(new Networking(RetrofitClient.getAPIService()), CacheManager.getInstance(new SharedPrefs(this)));
