...
constructor(
  ...
  override fun onFragmentInitiated() {
    ...
    composeView.setContent {
      val elections by displayElectionViewModel.finishedElections.collectAsState()
      ...
      AgoraTheme {
        ElectionsScreen(
          ...
          onSearch = {
            displayElectionViewModel.getFinishedElectionsState(it)
          },
  ...
  private fun bindUI() {
    displayElectionViewModel.getFinishedElectionsState("")
  }
}
