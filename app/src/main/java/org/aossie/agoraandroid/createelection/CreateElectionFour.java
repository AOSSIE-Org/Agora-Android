...
public class CreateElectionFour extends Fragment {
  ...
  private CreateElectionFourViewModel createElectionFourViewModel;
  ...
  private RadioGroup radioGroupBallots;
    ...
    createElectionFourViewModel =
        new CreateElectionFourViewModel(getActivity().getApplication(), getContext());
