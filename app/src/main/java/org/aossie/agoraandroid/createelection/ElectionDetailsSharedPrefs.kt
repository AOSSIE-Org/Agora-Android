...
class ElectionDetailsSharedPrefs(context: Context) {
    ...
    val voterListVisibility: Boolean
        get() = sharedPreferences.getBoolean(VoterListVisibilityKey, false)
    ...
    val ballotVisibility: String?
        get() = sharedPreferences.getString(BallotVisibilityKey, null)
    ...
    val electionDetails: String?
        get() = sharedPreferences.getString(ElectionDetailsKey, null)
