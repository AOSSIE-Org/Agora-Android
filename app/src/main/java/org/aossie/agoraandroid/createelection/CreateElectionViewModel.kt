...
internal class CreateElectionViewModel(application: Application, private val context: Context) : AndroidViewModel(application) {
    private val electionDetailsSharedPrefs = ElectionDetailsSharedPrefs(getApplication())
    ...
    fun createElection() {
        ...
        val electionResponse = apiService.createElection(jsonObject.toString(), token)
